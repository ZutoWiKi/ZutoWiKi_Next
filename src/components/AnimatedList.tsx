...
const AnimatedList = forwardRef<AnimatedListRef, AnimatedListProps>(
  (
    {
      items = [
        "Item 1",
      ...
      scrollToIndex: (index: number) => {
        ...
        if (targetItem) {
          ...
          const targetScrollTop =
            itemTop - containerHeight / 2 + targetItem.offsetHeight / 2;
