...
const GetMyPage: React.FC = () => {
  ...
  if (loading) return <div className="bg-white shadow-md rounded-2xl p-6 flex items-center space-x-4">유저 정보를 불러오는 중..</div>;
  if (!user) return <div className="bg-white shadow-md rounded-2xl p-6 flex items-center space-x-4">유저 정보를 불러올 수 없습니다.</div>;
